...
public class PreferNonpreferBrandSelectBoundary extends AppCompatActivity implements MyPageController.MyPageControlBrandCallback{//선호,비선호 브랜드 리스트 보는 화면
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        controller.MyPageControllerBrand(PreferNonpreferBrandSelectBoundary.this);
